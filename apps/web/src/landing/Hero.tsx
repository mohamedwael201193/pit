        ...
        <div className="container-pit relative flex min-h-[100svh] flex-col pt-20 pb-8 md:pt-24">
          <div className="grid flex-1 items-start gap-6 pt-4 lg:grid-cols-[1.25fr_0.75fr] lg:gap-10">
            <div>
              ...
              >
                PIT privately researches live markets with 0G, enforces the policy you set, and can act inside those
                limits. The sensitive execution surface stays on your computer.
              </motion.p>
              <motion.p
                className="mt-4 max-w-[40ch] text-[1.0625rem] leading-7 text-black/75"
                initial={reduce ? false : { opacity: 0, y: 12 }}
              ...
              >
                The web discovers and proves. The desktop protects and acts. Chat and this website cannot authorize, pin,
                or enable autonomy.
              </motion.p>
            </div>
          ...
          <div className="grid items-end gap-8 py-8 md:grid-cols-[1fr_auto] md:gap-14 md:py-10">
            ...
            >
              ...
              <figcaption className="border-t border-black bg-[#f0e7d4] px-3 py-2 text-[0.75rem] leading-4 text-black/75">
                ...
                Private research. Execution stays on the machine.
              </figcaption>
            </motion.figure>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3 pt-6 pb-2">
            ...
            <Link to="/proof" className="pill pill-ghost">
              Verify a mission
            </Link>
            {authenticated ? (
